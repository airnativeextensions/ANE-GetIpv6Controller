...
package
{
	import com.distriqt.test.getipv6controller.Main;
	...
	/**	
	 * Sample application for using the GetIpv6Controller Native Extension
	 */
	public class TestGetIpv6Controller extends Sprite
	{
		////////////////////////////////////////////////////////
		//	CONSTANTS
		//
		 ...
		 *  Constructor
		 */
		public function TestGetIpv6Controller()
		{
			super();
			if(this.stage)
			{
